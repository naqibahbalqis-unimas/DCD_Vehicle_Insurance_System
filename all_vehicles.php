...
$currentPage = ["Vehicles", "All Vehicles"]; // Replace with a dynamic value based on the URL or user action.
        ...
        <main class="flex-1  min-h-screen overflow-hidden"
            ...
            <section class="greeting mb-8 text-left ml-5 ">
                <div class="flex items-center justify-between">
                    <div class=" items-center gap-3">
                        <h1 class="md:text-4xl text-3xl font-bold mb-3">All Vehicles</h1>
            ...
            <section>
                <div flex items-center items-center justify-between>
                    <h1 class="text-4xl text-center font-bold"> Search Vehicle </h1>
            ...
            <section>
                <?php include 'components/full_vehicles_table.php'; ?>
            </section>
