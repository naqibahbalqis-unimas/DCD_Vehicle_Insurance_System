...
<body class="text-white bg-light-background dark:bg-dark-background dark:text-gray-200">
    <div class="grid gap-6 bg-light-sidebar dark:bg-dark-background md:grid-cols-3">
        <!-- Main Chart -->
        <div
        ...
        <div class="flex flex-col gap-6">
            <!-- Profits Chart -->
            <div
                class="rounded-lg dark:bg-dark-cardBg bg-light-sidebar border dark:border-dark-cardStroke border-dark-cardStroke shadow-md p-4 md:col-span-2">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-lg font-semibold text-light-cardText dark:text-dark-text">
                        Total Profits
                    </h2>
