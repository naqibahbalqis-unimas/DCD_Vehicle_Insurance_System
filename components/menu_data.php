...
$menuData = [
    ...
    [
        ...
        "subItems" => [
            ...
            ["title" => "Add New Vehicle", "url" => "/add_vehicle.php"],
        ],
    ],
    [
        ...
        "title" => "Linked Tables",
        "subItems" => [
            ["title" => "Policy – Policy Holder", "url" => "/policy_policy-holder.php"],
            ["title" => "Policy Holder – Vehicle", "url" => "/policy-holder_vehicle.php"],
        ],
    ],
    // [
