...
$currentPage = ["Policy Holders", ""]; // Replace with a dynamic value based on the URL or user action.
...
<head>
    ...
    <title>Edit Policy Holders | SafeDrive Vehicle Insurance System</title>
                            ...
                            <div class="flex flex-wrap gap-9 items-end">
                                <div class="flex flex-wrap grow shrink gap-5 items-start w-[928px] max-md:max-w-full">
                                    <div
                                        ...
                                        <label for="contactDetails" class="w-[481px] max-md:max-w-full">Policy Holder
                                            ID</label>
                                    </div>
                                    <input type="text" id="Policy_Holder_ID" value=""
                                    ...
                                    <div
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height=30"
                                            ...
                                            <circle cx="12" cy="6" r="4"
                                                fill="dark:fill-dark-cardText fill-light-text" />
                                        ...
                                        <div class="flex flex-wrap gap-8 w-full">
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <label for="dateOfBirth" class="self-stretch my-auto w-[379px]">Date
                                                        Of
                                                        Birth</label>
                                                </div>
                                                <div
                                                    class="flex flex-col justify-center mt-5 w-full whitespace-nowrap rounded-lg  max-md:max-w-full border dark:text-dark-text text-light-text dark:bg-dark-cardBg bg-light-sidebar dark:border-dark-cardStroke border-light-border">
                                                    <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                                        viewBox="0 0 15 15"
                                                        class="dark:text-dark-cardText text-light-text">
                                                    ...
                                                    <label for="licenseNumber"
                                                        class="self-stretch my-auto w-[379px]">Driving License
                                                        No.</label>
                                                </div>
