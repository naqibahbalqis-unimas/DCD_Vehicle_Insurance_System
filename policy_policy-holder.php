...
$currentPage = ["Linked Tables", "Policy – Policy Holder"]; // Replace with a dynamic value based on the URL or user action.
        ...
        <main class="flex-1  min-h-screen overflow-hidden"
            ...
            <section>
                <div flex items-center items-center justify-between>
                    <h1 class="text-4xl text-center font-bold"> Search Policy and Policy Holder </h1>
            ...
            <section>
                <?php include 'components/full_policy-policyholder_table.php'; ?>
            </section>
